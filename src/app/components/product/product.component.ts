...
import { Category, CategoryTreeNodeDTO } from '../../models/category.model';
import { CategoryAttribute, AttributeType } from '../../models/attribute.model';
import { CommonModule } from '@angular/common';
import { InputTextModule } from 'primeng/inputtext';
import { SelectModule } from 'primeng/select';
...
export class ProductFormComponent implements OnInit, OnChanges {
  productForm!: FormGroup;
categories = signal<CategoryTreeNodeDTO[]>([]);  categoryAttributes = signal<CategoryAttribute[]>([]);   /////
  attributeTypes = signal(Object.values(AttributeType));
  ...
  ngOnInit() {
    ...
    //if @Input categoryId is set before ngOnInit
    if (this.categoryId) {
